...
public class DashboardView extends View {
    ...
    private String mHeaderText = "DTS"; // 表头
    ...
    private void init() {
      ...
      //  mTexts = new String[]{"350", "较差", "550", "中等", "600", "良好", "650", "优秀", "700", "极好", "950"};
        mTexts = new String[]{"0", "极好", "100", "优秀", "200", "良好", "300", "中等", "400", "较差", "500"};
        mBgColors = new int[]{ContextCompat.getColor(getContext(), R.color.color_blue),
 ...
 /*   private float calculateRelativeAngleWithValue(int value) {
        ...
        if (value > 700) {
            ...
            return 5 * degreePerSection + 2 * degreePerSection / 50 * (value - 550);
        }else if (value > 200) {
            return 2 * degreePerSection + 2 * degreePerSection / 50 * (value - 200);
        }else {
            return 2 * degreePerSection / 200 ;
        }
    }
    */
    private float calculateRelativeAngleWithValue(int value) {
        ...
        if (value > 500) {
            ...
            return 8 * degreePerSection + 2 * degreePerSection / 120 * (value - 400);
        }else if (value > 300) {
            return 6 * degreePerSection + 2 * degreePerSection / 120 * (value - 300);
        }else if (value > 200) {
            return 4 * degreePerSection + 2 * degreePerSection / 120 * (value - 200);
        }else if (value > 100) {
            return 2 * degreePerSection + 2 * degreePerSection / 120 * (value - 100);
        }else if (value > 50) {
            return  degreePerSection + 2 * degreePerSection / 120 * (value - 50);
        }else {
            return 2 * degreePerSection / 120 * value;
        }
    }
    /**
     * 信用分对应信用描述
    ...
    private String calculateCreditDescription() {
        if (mSolidCreditValue > 500) {
            return "水质极差";
        } else if (mSolidCreditValue > 450) {
            return "水质较差";
        } else if (mSolidCreditValue > 300) {
            return "水质中等";
    ...
    public void setCreditValueWithAnim(int creditValue) {
        ...
        if (mSolidCreditValue > 450) {
            ...
            colorAnimator.setIntValues(mBgColors[0]);
            delay = 1000;
        }
